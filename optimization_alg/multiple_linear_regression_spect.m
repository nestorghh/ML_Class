...
%--------------------------------------------------------------------------
% La función multiple_linear_regression_spect es la implementación de la regresión
% lineal multiple haciendo uso del método del gradiente espectral (longitud del paso
% de Barzilai & Borwein) para minimizar la función de costo J.
%--------------------------------------------------------------------------
% Inputs
